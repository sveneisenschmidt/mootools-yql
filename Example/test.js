window.addEvent('domready', function() {
  ...
  var request1 = new Request.YQL(query1, {
    format: 'xml',
  ...
  var request2 = new Request.YQL(query2, {
  ...
  query3.select('*')
    ...
    var request3 = new Request.YQL(query3, {
  ...
  var request4 = new Request.YQL(query4, {
    onSuccess: function(result4) {
      console.log(result4);
    }
  }).send();  
});
